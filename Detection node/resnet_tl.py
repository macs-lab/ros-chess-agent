...
#change the direction below to the dataset you saved in your computer
...
#download the model and set the model only tuning the fully connected layers
model_ft = models.resnet50(pretrained=True)
#number of elemments in last fully connected layers's output 
